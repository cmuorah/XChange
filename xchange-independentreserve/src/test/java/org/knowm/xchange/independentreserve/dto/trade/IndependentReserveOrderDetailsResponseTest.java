...
public class IndependentReserveOrderDetailsResponseTest {
  ...
  public void testUnmarshall() throws IOException {
    ...
    assertThat(response.getVolumeOrdered()).isEqualByComparingTo(new Double(5));
    assertThat(response.getVolumeFilled()).isEqualByComparingTo(new Double(5));
    assertThat(response.getPrice()).isNull();
    assertThat(response.getAvgPrice()).isEqualByComparingTo(new Double(100));
    assertThat(response.getReservedAmount()).isEqualByComparingTo(new Double(0));
