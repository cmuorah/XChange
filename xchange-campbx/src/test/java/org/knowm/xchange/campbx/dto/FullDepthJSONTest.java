...
public class FullDepthJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(orderBook.getBids().get(0).get(0)).isEqualTo(new Double("13.3"));
    assertThat(orderBook.getBids().get(0).get(1)).isEqualTo(new Double("0.00021609"));
    assertThat(orderBook.getAsks().get(0).get(0)).isEqualTo(new Double("99.99"));
    assertThat(orderBook.getAsks().get(0).get(1)).isEqualTo(new Double("0.10000000"));
  }
}
