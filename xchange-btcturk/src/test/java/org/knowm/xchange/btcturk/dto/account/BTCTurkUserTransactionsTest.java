...
public class BTCTurkUserTransactionsTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(btcTurkUserTransactions[0].getFunds())
        .isEqualTo(new Double("23494.6206940035832218"));
    assertThat(btcTurkUserTransactions[0].getAmount()).isEqualTo(new Double("-1.0000000000000000"));
    assertThat(btcTurkUserTransactions[0].getFee()).isEqualTo(new Double("-0.5720337000000000"));
    assertThat(btcTurkUserTransactions[0].getTax()).isEqualTo(new Double("-0.1029660660000000"));
    assertThat(btcTurkUserTransactions[0].getPrice()).isEqualTo(new Double("450.0000000000000000"));
  }
}
