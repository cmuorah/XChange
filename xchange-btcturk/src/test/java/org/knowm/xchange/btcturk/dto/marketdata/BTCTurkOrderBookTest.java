...
public class BTCTurkOrderBookTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(btcTurkOrderBook.getBids().get(0).get(0)).isEqualTo(new Double("38620.00000000"));
    assertThat(btcTurkOrderBook.getBids().get(0).get(1)).isEqualTo(new Double("0.12500000"));
  }
}
