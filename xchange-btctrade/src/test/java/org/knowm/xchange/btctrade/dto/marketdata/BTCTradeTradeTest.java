...
public class BTCTradeTradeTest {
  ...
  public void testBTCTradeTrade() throws IOException {
    ...
    assertEquals(new Double("3703"), trades[0].getPrice());
    assertEquals(new Double("3.50000000000"), trades[0].getAmount());
    assertEquals(2895575L, trades[0].getTid());
    assertEquals("buy", trades[0].getType());

    assertEquals(1403397191L, trades[1].getDate());
    assertEquals(new Double("3704"), trades[1].getPrice());
    assertEquals(new Double("0.00200000000"), trades[1].getAmount());
    ...
    assertEquals(new Double("3740.01"), trades[trades.length - 2].getPrice());
    assertEquals(new Double("0.01000000000"), trades[trades.length - 2].getAmount());
    ...
    assertEquals(new Double("3752"), trades[trades.length - 1].getPrice());
    assertEquals(new Double("16.70000000000"), trades[trades.length - 1].getAmount());
