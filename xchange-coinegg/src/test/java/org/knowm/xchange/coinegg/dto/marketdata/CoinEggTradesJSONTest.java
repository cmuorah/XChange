...
public class CoinEggTradesJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(coinEggTrades[0].getPrice()).isEqualTo(new Double("3"));
    assertThat(coinEggTrades[0].getAmount()).isEqualTo(new Double("0.1"));
    ...
    assertThat(coinEggTrades[1].getPrice()).isEqualTo(new Double("32323"));
    assertThat(coinEggTrades[1].getAmount()).isEqualTo(new Double("2"));
