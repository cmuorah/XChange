...
public class CoinEggOrdersJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(coinEggOrders.getAsks()[0].getPrice()).isEqualTo(new Double("70000"));
    assertThat(coinEggOrders.getAsks()[0].getQuantity()).isEqualTo(new Double("5"));
    ...
    assertThat(coinEggOrders.getBids()[0].getPrice()).isEqualTo(new Double("38300"));
    assertThat(coinEggOrders.getBids()[0].getQuantity()).isEqualTo(new Double("1.879"));
  }
}
