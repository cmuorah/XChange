...
public class MarketOrder extends Order {
     ...
     */
    public MarketOrder(OrderType type, Double originalAmount, CurrencyPair currencyPair, String id, Long timestamp) {
     ...
     */
    public MarketOrder(
            OrderType type, Double originalAmount, CurrencyPair currencyPair, Long timestamp) {
