...
public class BitcointoyouOrderResponseTest {
  ...
  public void testOrderResponse() throws Exception {
    ...
    softly.assertThat(orderInfo.getPrice()).isEqualTo(new Double("500.9800000000"));
    softly.assertThat(orderInfo.getAmount()).isEqualTo(new Double("0.01000000"));
  ...
  public void testOrderResponseMultipleOrders() throws Exception {
    ...
    softly.assertThat(orderInfo.getPrice()).isEqualTo(new Double("2669.000000000000000"));
    softly.assertThat(orderInfo.getAmount()).isEqualTo(new Double("0.096589707883710"));
