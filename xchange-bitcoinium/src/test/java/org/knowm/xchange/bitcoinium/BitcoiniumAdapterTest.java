...
public class BitcoiniumAdapterTest {
  ...
  public void testOrderAdapterWithDepth() throws IOException {
    ...
    assertThat(orderBook.getAsks().get(0).getLimitPrice()).isEqualTo(new Double("522.9"));
    assertThat(orderBook.getAsks().get(0).getType()).isEqualTo(OrderType.ASK);
    assertThat(orderBook.getAsks().get(0).getOriginalAmount()).isEqualTo(new Double("1.07"));
  ...
  public void testTickerAdapter() throws IOException {
    ...
    assertThat(ticker.getLast()).isEqualTo(new Double("516.8"));
    assertThat(ticker.getLow().toString()).isEqualTo("508.28");
    assertThat(ticker.getHigh().toString()).isEqualTo("523.09");
    assertThat(ticker.getVolume()).isEqualTo(new Double("3522"));
  }
}
