...
public class BitcoiniumDepthJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(bitcoiniumOrderbook.getBitcoiniumTicker().getVolume()).isEqualTo(new Double("5787"));
    assertThat(bitcoiniumOrderbook.getBids()[0].getVolume()).isEqualTo(new Double("1.55"));
  }
}
