...
public class FullDepthJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(orderBook.getBids().get(0).get(0)).isEqualTo(new Double("123.09"));
    assertThat(orderBook.getBids().get(0).get(1)).isEqualTo(new Double("0.16248274"));
    assertThat(orderBook.getAsks().get(0).get(0)).isEqualTo(new Double("123.39"));
    assertThat(orderBook.getAsks().get(0).get(1)).isEqualTo(new Double("0.60466812"));
