...
public class CoinbaseProAdaptersTest {
    ...
    public void parseDateTest() {
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03Z")).isEqualTo(1493737803000L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.1Z")).isEqualTo(1493737803100L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.12Z")).isEqualTo(1493737803120L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.123Z")).isEqualTo(1493737803123L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.1234567Z")).isEqualTo(1493737803123L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03")).isEqualTo(1493737803000L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.1")).isEqualTo(1493737803100L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.12")).isEqualTo(1493737803120L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.123")).isEqualTo(1493737803123L);
        assertThat(CoinbaseProAdapters.parseDate("2017-05-02T15:10:03.123456")).isEqualTo(1493737803123L);
        assertThat(CoinbaseProAdapters.parseDate("2017-06-21T04:52:01.996Z")).isEqualTo(1498020721996L);
    }
    ...
    public void testTradeHistoryAdapter() throws IOException {
        ...
        assertThat(trade.getTimestamp()).isEqualTo(1493623910243L);
