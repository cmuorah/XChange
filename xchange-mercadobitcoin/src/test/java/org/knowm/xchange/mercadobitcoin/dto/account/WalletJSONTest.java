...
public class WalletJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    assertThat(accountInfo.getTheReturn().getFunds().getBrl()).isEqualTo(new Double("248.29516"));
    assertThat(accountInfo.getTheReturn().getFunds().getBtc()).isEqualTo(new Double("0.25000000"));
    assertThat(accountInfo.getTheReturn().getFunds().getLtc()).isEqualTo(new Double("0.00000000"));
  }
}
