...
public class DeribitAdaptersTest {
  ...
  public void adaptTicker() throws IOException {
    ...
    assertThat(ticker.getOpen()).isEqualTo(new Double("0.5"));
    assertThat(ticker.getLast()).isEqualTo(new Double("0.0075"));
    assertThat(ticker.getBid()).isEqualTo(new Double("0.01"));
    assertThat(ticker.getAsk()).isEqualTo(new Double("0.0135"));
    assertThat(ticker.getHigh()).isEqualTo(new Double("0.0625"));
    assertThat(ticker.getLow()).isEqualTo(new Double("0.0005"));
  ...
  public void adaptOrderBook() throws IOException {
    ...
    assertThat(orderBook.getBids().get(0).getOriginalAmount()).isEqualTo(new Double("30.0"));
    ...
    assertThat(orderBook.getBids().get(1).getLimitPrice()).isEqualTo(new Double("3940.75"));
    assertThat(orderBook.getBids().get(1).getOriginalAmount()).isEqualTo(new Double("102020.0"));
    ...
    assertThat(orderBook.getBids().get(2).getLimitPrice()).isEqualTo(new Double("3423.0"));
    assertThat(orderBook.getBids().get(2).getOriginalAmount()).isEqualTo(new Double("42840.0"));
