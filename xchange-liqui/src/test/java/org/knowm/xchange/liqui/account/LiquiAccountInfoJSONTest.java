...
public class LiquiAccountInfoJSONTest {
  ...
  public void testUnmarshall() throws Exception {
    ...
    final Map<Currency, Double> funds = resultFunds.getFunds();

    final Double btcFunds = funds.get(Currency.BTC);
    assertThat(btcFunds).isEqualTo(new Double("0.0"));

    final Double ltcFunds = funds.get(Currency.LTC);
    assertThat(ltcFunds).isEqualTo(new Double("1.123"));
