...
public class GlobitexTradeDtoJSONTest {
  ...
  public void executionReportObjectTest() throws IOException {
    ...
    assertThat(activeOrders.getObject().getLastQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastPrice()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLeavesQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getCumQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getAveragePrice()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastPrice()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastQuantity()).isEqualTo(0d);
    assertThat(activeOrders.getObject().getLastPrice()).isEqualTo(0d);
