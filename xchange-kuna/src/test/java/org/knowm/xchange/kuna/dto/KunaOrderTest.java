...
public class KunaOrderTest {
  ...
  public void test_remaining_volume() {
    assertEquals(
        0d, KunaOrder.builder().withRemainingVolume(0d).build().getRemainingVolume(), 1e-8);
    assertEquals(
        1d, KunaOrder.builder().withRemainingVolume(1d).build().getRemainingVolume(), 1e-8);
    assertEquals(
        10d, KunaOrder.builder().withRemainingVolume(10d).build().getRemainingVolume(), 1e-8);
  ...
  public void test_executed_volume() {
    ...
    assertEquals(
        10d, KunaOrder.builder().withExecutedVolume(10d).build().getExecutedVolume(), 1e-8);
