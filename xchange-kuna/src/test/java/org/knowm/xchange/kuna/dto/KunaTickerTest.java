...
public class KunaTickerTest {
    ...
    public void test_volume() {
        assertThat(KunaTicker.builder().withVol(MIN_VALUE).build().getVol()).isEqualTo(Double.valueOf(MIN_VALUE));
        assertThat(KunaTicker.builder().withVol(MAX_VALUE).build().getVol()).isEqualTo(Double.valueOf(MAX_VALUE));
