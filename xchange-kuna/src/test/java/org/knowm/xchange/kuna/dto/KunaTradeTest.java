...
public class KunaTradeTest {
  ...
  public void test_price() {
    assertEquals(0d, KunaTrade.builder().withPrice(0d).build().getPrice(), 1e-8);
    assertEquals(1d, KunaTrade.builder().withPrice(1d).build().getPrice(), 1e-8);
    assertEquals(10d, KunaTrade.builder().withPrice(10d).build().getPrice(), 1e-8);

    assertThat(trade.getPrice()).isEqualByComparingTo(Double.parseDouble("380505.0"));
  }
  ...
  public void test_volume() {
    assertEquals(0d, KunaTrade.builder().withVolume(0d).build().getVolume(), 1e-8);
    assertEquals(1d, KunaTrade.builder().withVolume(1d).build().getVolume(), 1e-8);
    assertEquals(10d, KunaTrade.builder().withVolume(10d).build().getVolume(), 1e-8);
    assertThat(trade.getVolume()).isEqualByComparingTo(Double.parseDouble("0.03536"));
  }

  @Test
  public void test_funds() {
    assertEquals(0d, KunaTrade.builder().withFunds(0d).build().getFunds(), 1e-8);
    assertEquals(1d, KunaTrade.builder().withFunds(1d).build().getFunds(), 1e-8);
    assertEquals(10d, KunaTrade.builder().withFunds(10d).build().getFunds(), 1e-8);
    assertThat(trade.getFunds()).isEqualByComparingTo(Double.parseDouble("13454.6568"));
  }
}
